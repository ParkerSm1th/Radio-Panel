...
$.ajax({
    type: 'POST',
    url: `${window.RadioPanelApp.apiBase}/managePermShows?action=get&show=<?php echo $row['id']?>`
}).done(function(response) {
  var prePop = JSON.parse(response);
  $("#hosts").tokenInput("' + window.RadioPanelApp.apiBase + '/managePermShows?action=findUser", {
    theme: "mac",
...
$(function() {
  ...
  $(form).submit(function(event) {
      ...
      $.ajax({
          type: 'POST',
          url: window.RadioPanelApp.apiBase + '/managePermShows?action=edit&show=<?php echo $row['id']?>',
          data: formData
      }).done(function(response) {
