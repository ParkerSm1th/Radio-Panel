          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-6" style="text-align: center;">
                ...
                <img id="currentPic" style="border-radius: 100px; height: 150px; width: 150px;" src="<?php echo web_path('profilePictures/' . $row['avatarURL']); ?>" onerror="this.src='<?php echo web_path('assets/images/square.png'); ?>'">
              </div>
              <div class="col-md-6">
...
$(form).submit(function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: window.RadioPanelApp.apiBase + '/updateProfilePic',
        data: formData,
        processData: false,
        contentType: false
...
$(form2).submit(function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: window.RadioPanelApp.apiBase + '/updateProfile',
        data: formData
    }).done(function(response) {
      console.log(response);
      if (response == 'updated') {
