...
if ($row['permRole'] == 5 || $row['permRole'] == 6) {
 ...
 <div class="card">
   <div class="card-body">
     ...
     <img style="height: 55px;border-radius: 100%;margin-bottom: 10px;" src="<?php echo web_path('profilePictures/' . $row['avatarURL']); ?>" onerror="this.src='<?php echo web_path('assets/images/default.png'); ?>'" alt="image">
 ...
 $(function() {
   ...
   $(form).submit(function(event) {
       ...
       $.ajax({
           type: 'POST',
           url: window.RadioPanelApp.apiBase + '/deleteUser?id=<?php echo $id ?>',
           data: null
