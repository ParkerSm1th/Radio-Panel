...
function claim() {
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/editApplication?id=<?php echo $id ?>&action=claim'
...
function unClaim() {
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/editApplication?id=<?php echo $id ?>&action=unclaim'
  }).done(function(response) {
    if (response == "done") {
...
function deny() {
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/editApplication?id=<?php echo $id ?>&action=deny'
  }).done(function(response) {
    if (response == "done") {
...
function accept() {
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/editApplication?id=<?php echo $id ?>&action=accept'
  }).done(function(response) {
    if (response == "done") {
