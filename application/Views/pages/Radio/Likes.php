    ...
    <div class="leaderboard">
      <div class="smallF first rank">
        ...
        <?php
         ...
         ?>
         <div class="blurBG s o8"><img src="<?php echo web_path('profilePictures/' . $row['avatarURL']); ?>" onerror="this.src='<?php echo web_path('assets/images/default.png'); ?>'" alt="image"></div>
         <div class="rank-content">
           <h1><img draggable="false" src="<?php echo web_path('profilePictures/' . $row['avatarURL']); ?>" onerror="this.src='<?php echo web_path('assets/images/default.png'); ?>'" alt="image"> <span class="userLink" onclick="loadProfile(<?php echo $row['id'] ?>)"><?php echo $row['username'] ?></span></h1>
