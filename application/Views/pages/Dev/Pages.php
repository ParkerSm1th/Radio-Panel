...
$(".moveUp").click(function(e) {
  ...
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/managePagePosition?page1=' + $(this).attr('data-id') + '&page2=' + otherId
...
$(".devMode").click(function(e) {
  ...
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/managePage?action=dev&page=' + $(this).attr('data-id')
  }).done(function(response) {
    console.log(response);
    if (response == "prod") {
      elem.html(`
...
$(".delete").click(function(e) {
  ...
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/managePage?action=delete&page=' + $(this).attr('data-id')
  }).done(function(response) {
    console.log(response);
    if (response == "deleted") {
