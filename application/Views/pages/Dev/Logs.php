            ...
            foreach($stmt as $row) {
              ...
              if (is_numeric($name)) {
                ...
                ?>
                  <tr>
                    <td class="py-1">
                      <img src="<?php echo web_path('profilePictures/' . $data['avatarURL']); ?>" onerror="this.src='<?php echo web_path('assets/images/default.png'); ?>'" alt="image"> <span class="userLink" onclick="loadProfile(<?php echo $data['id'] ?>)"><?php echo $data['username'] ?></span>
                    </td>
                    <td>
