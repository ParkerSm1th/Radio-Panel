                  ...
                  <tr>
                    <td class="py-1">
                      <?php if ($dj == 0) {
                        ...
                        ?>
                          <img src="<?php echo web_path('profilePictures/' . $toDJImg); ?>" onerror="this.src='<?php echo web_path('assets/images/default.png'); ?>'" alt="image"> <span class="userLink" onclick="loadProfile(<?php echo $data['id'] ?>)"><?php echo $toDJ ?></span>
                        <?php
                      }?>
                    </td>
                    <td>
...
function checkNew() {
  $.ajax({
      type: 'GET',
      url: window.RadioPanelApp.apiBase + '/newestRequest?streamer=0'
