          ...
          <?php
            ...
            foreach($stmt as $row) {
              ...
              ?>
                <tr>
                  <td class="py-1">
                    <img src="<?php echo web_path('profilePictures/' . $data['avatarURL']); ?>" onerror="this.src='<?php echo web_path('assets/images/default.png'); ?>'" alt="image"> <span class="userLink <?php echo $color ?>" onclick="loadProfile(<?php echo $data['id'] ?>)"><?php echo $row['dj_name'] ?></span>
                  </td>
                  <td>
